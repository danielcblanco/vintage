...
<body class="single-page">
	<div class="wrap-body">
		<!-- Intro -->
		 <div id="intro">
            <span class="line-1">hola bienvenido a</span>
            <figure class="cabecera">
                <img src="images/logo.png" alt="">
            </figure>
            <!--<span class="line-2">Vintage</span> -->
            <span class="line-3">Diseño Gráfico y Fotografía</span>
            <span class="line-4"><a href="#">Mis servicios</a><a href="#">Tomemos un café</a></span>
        </div>
